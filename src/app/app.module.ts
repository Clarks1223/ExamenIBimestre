...
import { SplashScreen } from '@ionic-native/splash-screen/ngx'; // Si estás usando una versión anterior de Ionic
...
@NgModule({
  ...
  imports: [
    ...
    AngularFirestoreModule // Agregar AngularFirestoreModule para Firestore
  ],
